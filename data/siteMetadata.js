const siteMetadata = {
  title: 'CY 愛呷冰 | Be a Frontend ',
  author: 'Ally Yeh',
  headerTitle: 'CY 愛呷冰。前端',
  description: '在前端工程師的路上，分享、記錄學習的知識與心得',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: '',
  siteRepo: 'https://github.com/a2623212/nextjs-tailwind-blog',
  siteLogo: '/static/images/site-icon.jpg',
  image: '',
  socialBanner: '',
